  ...
  return (
    <div className="relative mb-1.5" ref={ref}>
      ...
      >
        ...
        <svg viewBox="0 0 24 24" fill="none" stroke="var(--color-ink-4)" strokeWidth="2" className="h-3 w-3 flex-shrink-0">
            ...
            {projects.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <svg viewBox="0 0 24 24" fill="none" stroke="var(--color-yellow-deep)" strokeWidth="2.5" className="h-3.5 w-3.5">
